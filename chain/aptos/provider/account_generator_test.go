...
func Test_AccountGenPrivateKey(t *testing.T) {
	...
	var (
		// A valid private key in hex format
		privateKey = "0xE4FD0E90D32CB98DC6AD64516A421E8C2731870217CDBA64203CEB158A866304"
		// The expected account address for the given private key
		accountAddr = "0x9b7a7333d1abd0e9c2a27d00a8a7a131d30d3b09908739d52693fe513e205c38"
	)
	...
	tests := []struct {
	...
	}{
		{
			...
			givePrivateKey: privateKey,
			wantAddr:       accountAddr,
		},
		{
			name:           "invalid private key",
			givePrivateKey: "invalid_private_key",
