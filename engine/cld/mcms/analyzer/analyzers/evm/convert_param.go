...
// ConvertParam converts a DecodedParameter's ABI-decoded value into a typed
// Go binding struct.
// Example:
//
// config, err := evm.ConvertParam[token_pool.TokenPoolChainUpdate](param)
func ConvertParam[T any](param analyzer.DecodedParameter) (T, error) {
...
// ConvertParamSlice converts a DecodedParameter's ABI-decoded slice of anonymous
// structs into a typed slice of Go binding structs.
//
//	updates, err := evm.ConvertParamSlice[token_pool.TokenPoolChainUpdate](param)
func ConvertParamSlice[T any](param analyzer.DecodedParameter) ([]T, error) {
