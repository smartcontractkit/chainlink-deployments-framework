...
func resolveChangesetConfig(valueNode *yaml.Node, csName string, resolver migrations.ConfigResolver) (any, error) {
	var resolvedCfg any
	...
	if resolver != nil {
		...
		resolvedCfg, err = migrations.CallResolver[any](resolver, raw)
		if err != nil {
